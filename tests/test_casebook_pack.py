"""Regression checks for the copper-dev-config-meter casebook."""
...
from casebook.harness import assert_expected, copper_dev_config_meter_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_dev_config_meter_summary(), assert_expected())
